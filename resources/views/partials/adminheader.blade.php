...
<nav class="navbar navbar-light bg-light p-3">
    <div class="d-flex col-12 col-md-3 col-lg-2 mb-2 mb-lg-0 flex-wrap flex-md-nowrap justify-content-between">
        <a class="navbar-brand" href="#">
           ...
           <span class="title"> {{config('app.name', 'Msave')}} Admin</span>
        </a>
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="position-sticky pt-md-5">
                <ul class="nav flex-column nav-pills">
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is('admin/dashboard')?'active text-white':'')}}" aria-current="page" href="{{route('admin/dashboard')}}">
                            <x-bi-speedometer2/>
                            <span class="ml-2">Overview</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{(Request::is('admin/users')?'active text-white':'')}}" href="{{route('admin/users')}}">
                            <x-bi-person-add/>
